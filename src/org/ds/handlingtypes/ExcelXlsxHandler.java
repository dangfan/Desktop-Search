...
/**
 * 处理Microsoft Excel 2007/2010 文件
 */
public class ExcelXlsxHandler implements FileHandler
{
            ...
            throws FileHandlerException
    {
        ...
        XSSFExcelExtractor docx = null;  //文件对象

        //读入文件
        try
        {
            docx = new XSSFExcelExtractor(new XSSFWorkbook(new FileInputStream(
                    file)));
        }
        catch (IOException e)
        {
